...
def _get_train_data(random_test_sample = True):
    ...
    if FLAGS.train_mode == 'ftm' or FLAGS.train_mode == 'f2m':
        ...
        source_filter = {'Male':False, 'Blurry':False, 'Eyeglasses':False, 'Attractive':True, 'Eyeglasses': False, 'Wearing_Hat': False, 'Goatee':False, 'Mustache':False, 'No_Beard':True}
        target_filter = {'Male':True,  'Blurry':False, 'Eyeglasses':False, 'Attractive':True, 'Eyeglasses': False, 'Wearing_Hat': False, 'Goatee':False, 'Mustache':False, 'No_Beard':True}
    elif FLAGS.train_mode == 'mtf' or FLAGS.train_mode == 'm2f':
        # Trans filter: from male to attractuve female
        source_filter = {'Male':True,  'Blurry':False, 'Eyeglasses':False, 'Attractive':True, 'Eyeglasses': False, 'Wearing_Hat': False, 'Goatee':False, 'Mustache':False, 'No_Beard':True}
        target_filter = {'Male':False, 'Blurry':False, 'Eyeglasses':False, 'Attractive':True, 'Eyeglasses': False, 'Wearing_Hat': False, 'Goatee':False, 'Mustache':False, 'No_Beard':True}
